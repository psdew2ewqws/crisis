...
// NOTE: The live-news client (getNews / getNewsAnalysis) was removed when the
// Jordan governorate map was replaced by the Middle East crisis-signal map. The
// new live feed is served by /api/rss/* — see lib/rss.ts.
